    ...
    "paths": {
        "/portfolios": {
            "get": {
                ...
                "description": "IMPORTANT - Admin username is \"admin\" with password \"admin_password\". The portfolios endpoint returns all portfolios stored on the system. The response includes the user who owns the portfolio, the number of assets in the portfolio and the net asset value of the portfolio. In addition, a link is provided for each portfolio to its full object.",
                "tags": [
                    "Portfolios"
                ],
                "responses": {
